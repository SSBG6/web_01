...
<head>
    ...
    <body>      
                ...
                <table class="table">
                        ...
                        <button type="submit" name="del" class="btn btn-danger  btn-lg btn-block text-uppercase">Delete from cart</button><br><br>
                        </form> 
                        </div>
                        <?php
                        $ordid = $_POST['on'];
                        if (isset($_POST['addorder'])) {
                           ...
                           $sql = "INSERT INTO `orders` VALUES ('$ordid','$username', '$prodn','$qt','$add','$cit','Cash on Delivery','$cont','processing')";
                            ...
                            if (isset($_POST['delete'])) {
                                echo $ordid;
                                $sql = "DELETE * FROM cart WHERE orderid = '$ordid'"; 
                                 } else {
                                     //echo "Nothing was posted";
                                 }
                                 if (mysqli_query($conn, $sql)) {
